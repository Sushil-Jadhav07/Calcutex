                    ...
                    <div className="w-full xl:w-5/12 flex flex-col gap-y-6">
                        ...
                        <div className="list-service">
                            <div className="service-item flex items-center">
                                ...
                                <div className="text-button ml-3">Leads to 40 to 50% of cost savings in your bookkeeping costs.</div>
                            </div>
                            <div className="service-item flex items-center mt-3">
                                <Icon.Check weight="bold" className="text-blue text-2xl" />
                                <div className="text-button ml-3">Real time Accounting & Reporting to help you take business decisions.</div>
                            </div>
                            <div className="service-item flex items-center mt-3">
                                <Icon.Check weight="bold" className="text-blue text-2xl" />
                                <div className="text-button ml-3">Assured confidentiality and zero tolerance policy towards maintaining data security and data privacy.</div>
                            </div>
                        </div>
                        <div className="button-block">
                            <Link className="button-main hover:bg-blue text-white bg-black rounded-full" href="contact-two.html">Know More</Link>
                        </div>
                    </div>

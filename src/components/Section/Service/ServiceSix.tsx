        ...
        <>
            <div className="service-block style-six lg:pt-[100px] sm:pt-16 pt-10">
                <div className="container flex flex-col items-center">
                    <div className="heading3 lg:w-7/12 text-black text-center">Our services</div>
                    <div className="body3 text-black text-center mt-6 w-full lg:w-1/2 sm:w-2/3">
                        {`This is  simply dummy text printing and typesetting industry been industry's. This is  simply dummy text been industry.`}
                        <Link className="text-button duration-300 underline ml-2 text-black hover:text-orange" href="/service/service-one">View case</Link>
                    </div>

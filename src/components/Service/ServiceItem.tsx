                ...
                >
                    ...
                    >
                        <div className="heading flex items-center justify-between">
                            <i className={`${data.icon}  hover:text-orange md:text-6xl text-5xl`}></i>
                ...
                <div className="service-item rounded-2xl border border-line hover-box-shadow">
                    ...
                    >
                        <div className="icon md:w-[100px] w-20 md:h-[100px] h-20 flex items-center justify-center rounded-2xl">
                            <i className={`${data.icon} text-black md:text-5xl text-4xl`}></i>
                        </div>
                        <div className="heading7 text-black hover:text-orange duration-300 mt-6">{data.title}</div>
